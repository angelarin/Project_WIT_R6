...
urlpatterns = [
     ...
     path('shirts', views.ShirtsListView.as_view(), name='shirts_view'),
     path('sportwear', views.SportwearListView.as_view(), name='sportwear'),
     path('outwear', views.OutwearListView.as_view(), name='outwear'),
     path('kat-pants', views.PantsListView.as_view(), name='pants_view'),
